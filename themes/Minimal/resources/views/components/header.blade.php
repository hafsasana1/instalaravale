<header x-data="HeaderComponent()" class="header" aria-label="Main Header">
    ...
    <nav aria-label="Main Navigation" :class="{'is-open': showNav}">
        <ul>
            <li>
                <a href="https://getreelaudio.com/instagram-reels-audio-download" target="_blank" rel="noopener" class="nav-item-link">
            ...
            <li>
                <a href="https://getreelaudio.com/instagram-stories-audio-download" target="_blank" rel="noopener" class="nav-item-link">
            ...
            <li>
                <a href="https://getreelaudio.com/instagram-highlights-download" target="_blank" rel="noopener" class="nav-item-link">
            ...
            <li>
                <a href="https://getreelaudio.com/blog/instagram-audio-download-hub" target="_blank" rel="noopener" class="nav-item-link">
            ...
            <li>
                <a href="https://getreelaudio.com/faq" target="_blank" rel="noopener" class="nav-item-link">
            ...
            <li>
                <a href="https://getreelaudio.com/blog" target="_blank" rel="noopener" class="nav-item-link">
